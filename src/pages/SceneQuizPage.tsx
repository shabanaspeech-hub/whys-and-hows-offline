    ...
    <div className="min-h-screen bg-background flex flex-col overflow-y-auto">
      ...
      <div className="px-3 pt-3 sm:px-5 lg:px-8">
        <motion.img
          ...
          alt={scene.title}
          loading="lazy"
          className="mx-auto h-auto max-h-[34vh] w-auto max-w-full object-contain rounded-3xl shadow-playful border-4 border-card bg-card cursor-pointer sm:max-h-none sm:w-[76vw] md:w-[74vw] lg:w-[61vw] xl:w-[58vw] lg:max-w-6xl"
