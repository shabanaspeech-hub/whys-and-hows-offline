    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="pt-8 pb-4 px-4 flex flex-col items-center">
        ...
        <motion.button
          ...
          className="mt-4 inline-flex items-center gap-2 bg-card text-foreground px-5 py-2.5 rounded-2xl shadow-playful-sm font-bold text-base hover:scale-[1.03] transition-transform"
        >
