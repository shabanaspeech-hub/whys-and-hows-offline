...
export const scenes: Scene[] = [
  {
    ...
    questions: [
      ...
      { question: "What is flying in the sky?", choices: [{ text: "A bird", emoji: "🐦" }, { text: "A kite", emoji: "🪁" }], correctIndex: 0, correctFeedback: "That's right! A bird is flying in the sky!" },
      ...
      { question: "Why does the dog run on the grass?", choices: [{ text: "To play and have fun", emoji: "🐕" }, { text: "To go to sleep", emoji: "😴" }], correctIndex: 0, correctFeedback: "Yes! The dog runs on the grass to play and have fun!" },
  ...
  // ═══════════════════════════════════════════════════
  // FIX #1 — KITCHEN: cat is ON the table, not under
  // ═══════════════════════════════════════════════════
  {
    ...
    objectTags: [
      ...
      { object: "cat", location: "on the table" },
    ...
    questions: [
      ...
      { question: "Where is the cat?", choices: [{ text: "On the table", emoji: "🍽️" }, { text: "Under the chair", emoji: "⬇️" }], correctIndex: 0, correctFeedback: "Yes! The cat is on the table!" },
      ...
      { question: "Why should we wash our hands before eating?", choices: [{ text: "To get rid of germs", emoji: "🧼" }, { text: "To make them wet", emoji: "💧" }], correctIndex: 0, correctFeedback: "Yes! We wash our hands before eating to get rid of germs!" },
  ...
  // ═══════════════════════════════════════════════════
  // FIX #2 — SCHOOL: children sit on chairs (not desks)
  // emoji changed from 📚 (book) to 🪑 (chair)
  // ═══════════════════════════════════════════════════
  {
    id: "classroom", title: "At School", image: sceneClassroom, emoji: "🏫",
    objectTags: [
      { object: "teacher", location: "at the board" },
      { object: "children", location: "sitting on chairs" },
    ...
    questions: [
      ...
      { question: "Where are the children sitting?", choices: [{ text: "On chairs", emoji: "🪑" }, { text: "On the floor", emoji: "⬇️" }], correctIndex: 0, correctFeedback: "That's right! The children are sitting on chairs!" },
      { question: "What is on the wall?", choices: [{ text: "A clock", emoji: "🕐" }, { text: "A TV", emoji: "📺" }], correctIndex: 0, correctFeedback: "Yes! A clock is on the wall!" },
      ...
      { question: "Why should you raise your hand?", choices: [{ text: "To ask a question", emoji: "✋" }, { text: "To wave goodbye", emoji: "👋" }], correctIndex: 0, correctFeedback: "Yes! You raise your hand to ask a question!" },
  ...
  // ═══════════════════════════════════════════════════
  // FIX #3 — BEDROOM: nightstand → side table,
  // moon = dark/night sky, teddy on bed (confirmed)
  // FIX #4 — teddy WHY: removed absurd distractors
  // ═══════════════════════════════════════════════════
  {
    id: "bedroom", title: "Bedtime", image: sceneBedroom, emoji: "🛏️",
    objectTags: [
      { object: "child", location: "in bed" },
      { object: "moon", location: "in the dark sky through the window" },
      { object: "teddy bear", location: "on the bed" },
      { object: "lamp", location: "on the side table" },
    ],
    questions: [
      ...
      { question: "What can you see through the window?", choices: [{ text: "The dark night sky", emoji: "🌙" }, { text: "The bright sun", emoji: "☀️" }], correctIndex: 0, correctFeedback: "That's right! You can see the dark night sky through the window!" },
      { question: "Where is the teddy bear?", choices: [{ text: "On the bed", emoji: "🛏️" }, { text: "On the chair", emoji: "🪑" }], correctIndex: 0, correctFeedback: "Yes! The teddy bear is on the bed!" },
      { question: "What is on the side table?", choices: [{ text: "A lamp", emoji: "💡" }, { text: "A toy", emoji: "🧸" }], correctIndex: 0, correctFeedback: "That's right! A lamp is on the side table!" },
      ...
      { question: "Why does the child hug the teddy bear?", choices: [{ text: "To feel safe and cozy", emoji: "🧸" }, { text: "To stay awake", emoji: "😳" }], correctIndex: 0, correctFeedback: "Yes! The child hugs the teddy bear to feel safe and cozy!" },
  ...
  // ═══════════════════════════════════════════════════
  // FIX #5 — BEACH: goggles WHY — replaced irrelevant
  // distractors with plausible, visually grounded ones
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "Who is swimming?", choices: [{ text: "A boy", emoji: "👦" }, { text: "A dog", emoji: "🐕" }], correctIndex: 0, correctFeedback: "That's right! A boy is swimming!" },
      { question: "What is flying in the sky?", choices: [{ text: "A seagull", emoji: "🐦" }, { text: "A kite", emoji: "🪁" }], correctIndex: 0, correctFeedback: "Yes! A seagull is flying in the sky!" },
      ...
      { question: "Why is the boy wearing goggles?", choices: [{ text: "To see underwater", emoji: "🥽" }, { text: "To block the wind", emoji: "💨" }], correctIndex: 0, correctFeedback: "Yes! The boy is wearing goggles to see underwater!" },
      { question: "What would happen if a big wave came?", choices: [{ text: "The sandcastle would fall", emoji: "🌊" }, { text: "The sand would fly away", emoji: "💨" }], correctIndex: 0, correctFeedback: "That's right! If a big wave came, the sandcastle would fall down!" },
    ],
  },

  // ═══════════════════════════════════════════════════
  // FARM — global review: all verified correct
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What color is the barn?", choices: [{ text: "Red", emoji: "🔴" }, { text: "Blue", emoji: "🔵" }], correctIndex: 0, correctFeedback: "Yes! The barn is red!" },
      ...
      { question: "Why do pigs roll in mud?", choices: [{ text: "To stay cool", emoji: "🐷" }, { text: "To take a bath", emoji: "🛁" }], correctIndex: 0, correctFeedback: "Yes! Pigs roll in mud to stay cool!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    objectTags: [
      ...
      { object: "monkey", location: "climbing a tree" },
    ...
    questions: [
      ...
      { question: "Who is climbing?", choices: [{ text: "The monkey", emoji: "🐒" }, { text: "The lion", emoji: "🦁" }], correctIndex: 0, correctFeedback: "Yes! The monkey is climbing!" },
      ...
      { question: "Why are the animals in enclosures?", choices: [{ text: "To keep them safe", emoji: "🔒" }, { text: "Because they are sleeping", emoji: "😴" }], correctIndex: 0, correctFeedback: "Yes! The animals are in enclosures to keep them safe!" },
      { question: "When can you visit the zoo?", choices: [{ text: "During the day", emoji: "☀️" }, { text: "At midnight", emoji: "🌙" }], correctIndex: 0, correctFeedback: "That's right! You can visit the zoo during the day!" },
      { question: "Why does the elephant spray water?", choices: [{ text: "To cool down", emoji: "💦" }, { text: "To water flowers", emoji: "🌸" }], correctIndex: 0, correctFeedback: "Yes! The elephant sprays water to cool down!" },
      { question: "What would happen if a monkey escaped?", choices: [{ text: "It would climb everywhere", emoji: "🐒" }, { text: "It would sit still", emoji: "🪑" }], correctIndex: 0, correctFeedback: "That's right! If a monkey escaped, it would climb everywhere!" },
    ],
  },

  // ═══════════════════════════════════════════════════
  // BIRTHDAY — verified correct
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What is next to the cake?", choices: [{ text: "Presents", emoji: "🎁" }, { text: "Books", emoji: "📚" }], correctIndex: 0, correctFeedback: "Yes! Presents are next to the cake!" },
      ...
      { question: "Why do people give presents?", choices: [{ text: "To celebrate and show love", emoji: "🎁" }, { text: "Because they have to", emoji: "😐" }], correctIndex: 0, correctFeedback: "Yes! People give presents to celebrate and show love!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What is the boy picking?", choices: [{ text: "Fruit", emoji: "🍎" }, { text: "Candy", emoji: "🍬" }], correctIndex: 0, correctFeedback: "That's right! The boy is picking fruit!" },
      ...
      { question: "Why does Mom make a shopping list?", choices: [{ text: "To remember what to buy", emoji: "📝" }, { text: "To draw pictures", emoji: "🎨" }], correctIndex: 0, correctFeedback: "Yes! Mom makes a shopping list to remember what to buy!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "How many kids are playing?", choices: [{ text: "Four", emoji: "4️⃣" }, { text: "Two", emoji: "2️⃣" }], correctIndex: 0, correctFeedback: "That's right! Four kids are playing!" },
      ...
      { question: "Why do kids play together?", choices: [{ text: "Because it's more fun", emoji: "😄" }, { text: "Because they have to", emoji: "😐" }], correctIndex: 0, correctFeedback: "Yes! Kids play together because it is more fun!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "Who is holding a clipboard?", choices: [{ text: "The nurse", emoji: "👩‍⚕️" }, { text: "The boy", emoji: "👦" }], correctIndex: 0, correctFeedback: "Yes! The nurse is holding a clipboard!" },
      ...
      { question: "Why does the doctor listen to your heart?", choices: [{ text: "To check if it's healthy", emoji: "❤️" }, { text: "To hear music", emoji: "🎵" }], correctIndex: 0, correctFeedback: "Yes! The doctor listens to your heart to check if it is healthy!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What is in the sky?", choices: [{ text: "A rainbow", emoji: "🌈" }, { text: "Stars", emoji: "⭐" }], correctIndex: 0, correctFeedback: "Yes! A rainbow is in the sky!" },
      ...
      { question: "Why do we use an umbrella?", choices: [{ text: "To stay dry", emoji: "☂️" }, { text: "To block the sun", emoji: "☀️" }], correctIndex: 0, correctFeedback: "Yes! We use an umbrella to stay dry!" },
      ...
      { question: "Why are there puddles on the ground?", choices: [{ text: "Because it rained", emoji: "🌧️" }, { text: "Because someone spilled water", emoji: "💧" }], correctIndex: 0, correctFeedback: "Yes! There are puddles on the ground because it rained!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "Where are the children sitting?", choices: [{ text: "At the tables", emoji: "🪑" }, { text: "Outside", emoji: "🌳" }], correctIndex: 0, correctFeedback: "That's right! The children are sitting at the tables!" },
      { question: "Who helps you find books?", choices: [{ text: "The librarian", emoji: "📖" }, { text: "The doctor", emoji: "👨‍⚕️" }], correctIndex: 0, correctFeedback: "Yes! The librarian helps you find books!" },
      ...
      { question: "Why do people go to the library?", choices: [{ text: "To borrow and read books", emoji: "📖" }, { text: "To sleep", emoji: "😴" }], correctIndex: 0, correctFeedback: "Yes! People go to the library to borrow and read books!" },
  ...
  // ═══════════════════════════════════════════════════
  // GARDEN — verified correct
  // ═══════════════════════════════════════════════════
  {
    id: "garden", title: "In the Garden", image: sceneGarden, emoji: "🌻",
    objectTags: [
      { object: "grandma", location: "watering flowers" },
      { object: "boy", location: "digging in the soil" },
      { object: "butterflies", location: "flying around flowers" },
      { object: "sunflowers", location: "growing in the garden" },
    ],
    questions: [
      ...
      { question: "What is the boy doing?", choices: [{ text: "Digging", emoji: "⛏️" }, { text: "Running", emoji: "🏃" }], correctIndex: 0, correctFeedback: "That's right! The boy is digging!" },
      { question: "What is flying around?", choices: [{ text: "Butterflies", emoji: "🦋" }, { text: "Birds", emoji: "🐦" }], correctIndex: 0, correctFeedback: "Yes! Butterflies are flying around!" },
      ...
      { question: "Why do bees visit flowers?", choices: [{ text: "To collect nectar", emoji: "🐝" }, { text: "To sleep on them", emoji: "😴" }], correctIndex: 0, correctFeedback: "Yes! Bees visit flowers to collect nectar!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What is floating?", choices: [{ text: "Bubbles", emoji: "🫧" }, { text: "Boats", emoji: "⛵" }], correctIndex: 0, correctFeedback: "Yes! Bubbles are floating!" },
      ...
      { question: "Why do we use soap?", choices: [{ text: "To wash away germs", emoji: "🧴" }, { text: "To eat it", emoji: "🍽️" }], correctIndex: 0, correctFeedback: "Yes! We use soap to wash away germs!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      { question: "Who works here?", choices: [{ text: "A firefighter", emoji: "👨‍🚒" }, { text: "A teacher", emoji: "👩‍🏫" }], correctIndex: 0, correctFeedback: "Yes! A firefighter works at the fire station!" },
      { question: "What color is the fire truck?", choices: [{ text: "Red", emoji: "🔴" }, { text: "Blue", emoji: "🔵" }], correctIndex: 0, correctFeedback: "That's right! The fire truck is red!" },
      ...
      { question: "When should you call for help?", choices: [{ text: "In an emergency", emoji: "🚨" }, { text: "When you're bored", emoji: "😐" }], correctIndex: 0, correctFeedback: "That's right! You should call for help in an emergency!" },
      { question: "Why is the fire truck red?", choices: [{ text: "So people can see it easily", emoji: "🔴" }, { text: "Because red is pretty", emoji: "🌹" }], correctIndex: 0, correctFeedback: "Yes! The fire truck is red so people can see it easily!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What are they eating?", choices: [{ text: "Sandwiches", emoji: "🥪" }, { text: "Pizza", emoji: "🍕" }], correctIndex: 0, correctFeedback: "That's right! They are eating sandwiches!" },
      ...
      { question: "Why do ants come to the picnic?", choices: [{ text: "They smell the food", emoji: "🐜" }, { text: "They want to play", emoji: "😄" }], correctIndex: 0, correctFeedback: "Yes! Ants come to the picnic because they smell the food!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What bird is there?", choices: [{ text: "A parrot", emoji: "🦜" }, { text: "A penguin", emoji: "🐧" }], correctIndex: 0, correctFeedback: "Yes! A parrot is at the pet shop!" },
      ...
      { question: "Why do fish live in water?", choices: [{ text: "They breathe with gills", emoji: "🐟" }, { text: "They like swimming pools", emoji: "🏊" }], correctIndex: 0, correctFeedback: "Yes! Fish live in water because they breathe with gills!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "What is falling from the sky?", choices: [{ text: "Snowflakes", emoji: "❄️" }, { text: "Rain", emoji: "🌧️" }], correctIndex: 0, correctFeedback: "That's right! Snowflakes are falling from the sky!" },
      ...
      { question: "Why does the snowman melt?", choices: [{ text: "Because the sun warms it up", emoji: "☀️" }, { text: "Because it's hungry", emoji: "🍔" }], correctIndex: 0, correctFeedback: "Yes! The snowman melts because the sun warms it up!" },
  ...
  // ═══════════════════════════════════════════════════
  {
    ...
    questions: [
      ...
      { question: "Who is waving goodbye?", choices: [{ text: "The mom", emoji: "👩" }, { text: "The teacher", emoji: "👩‍🏫" }], correctIndex: 0, correctFeedback: "That's right! The mom is waving goodbye!" },
      ...
      { question: "Why should you wait in line at the bus stop?", choices: [{ text: "To be safe and fair", emoji: "🤝" }, { text: "To play a game", emoji: "🎮" }], correctIndex: 0, correctFeedback: "Yes! You should wait in line at the bus stop to be safe and fair!" },
